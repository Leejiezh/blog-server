package blog.common.utils.file;
...
import blog.common.exception.file.FileNameLengthLimitExceededException;
import blog.common.exception.file.FileSizeLimitExceededException;
import blog.common.exception.file.InvalidExtensionException;
import blog.common.utils.DateUtils;
import blog.common.utils.StringUtils;
import blog.common.utils.uuid.IdUtils;
import blog.common.utils.uuid.Seq;
...
public class FileUploadUtils {
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = BlogServerConfig.getProfile();
    ...
    public static final String getPathFileName(String uploadDir, String fileName) throws IOException {
        int dirLastIndex = BlogServerConfig.getProfile().length() + 1;
