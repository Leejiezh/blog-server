package blog.framework.aspectj;
...
import blog.common.enums.BusinessStatus;
import blog.common.enums.HttpMethod;
import blog.common.filter.PropertyPreExcludeFilter;
import blog.common.utils.ExceptionUtil;
        ...
        try {
            ...
            if (loginUser != null) {
                ...
                if (StringUtils.isNotNull(currentUser)){
                    ...
                    operLog.setCreateById(currentUser.getUserId());
